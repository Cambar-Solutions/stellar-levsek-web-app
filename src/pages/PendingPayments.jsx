    ...
    <Layout>
      ...
      <div className="mb-6 sm:mb-8">
        <div className="flex items-center gap-2 sm:gap-3 mb-4">
          <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-orange-400 to-orange-600 rounded-lg sm:rounded-xl flex items-center justify-center shadow-lg flex-shrink-0">
          ...
          <Card className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 border-blue-200 dark:border-blue-700">
            <CardContent className="p-3 sm:p-4">
              <div className="flex items-center justify-between">
                ...
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-blue-200 dark:bg-blue-800 rounded-full flex items-center justify-center flex-shrink-0">
                  <Clock className="w-5 h-5 sm:w-6 sm:h-6 text-blue-700 dark:text-blue-300" />
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 border-green-200 dark:border-green-700">
            <CardContent className="p-3 sm:p-4">
              <div className="flex items-center justify-between">
                ...
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-green-200 dark:bg-green-800 rounded-full flex items-center justify-center flex-shrink-0">
                  <DollarSign className="w-5 h-5 sm:w-6 sm:h-6 text-green-700 dark:text-green-300" />
                </div>
              </div>
            </CardContent>
          </Card>
      ...
      {pendingPayments.length > 0 && (
        <div className="bg-gradient-to-r from-orange-50 to-yellow-50 dark:from-orange-900/20 dark:to-yellow-900/20 border border-orange-200 dark:border-orange-700 rounded-lg sm:rounded-xl p-3 sm:p-4 mb-4 sm:mb-6 shadow-sm">
      ...
      {pendingPayments.length === 0 ? (
        <Card className="border-2 border-dashed border-gray-200 dark:border-gray-700">
          <CardContent className="p-8 sm:p-12 text-center">
            <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-800 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
              ...
              >
                <CardContent className="p-4 sm:p-6">
                  <div className="flex flex-col lg:flex-row gap-4 sm:gap-6">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 mb-4">
                        <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
                          <Avatar name={payment.debtor.name} size="lg" className="flex-shrink-0" />
                          <div className="min-w-0 flex-1">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-4">
                        <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-lg sm:rounded-xl p-3 sm:p-4 border border-green-200 dark:border-green-700">
                      ...
                      <div className="space-y-2 sm:space-y-3 p-3 sm:p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg sm:rounded-xl border border-blue-200 dark:border-blue-700">
                        <div>
                          <p className="text-xs text-blue-700 dark:text-blue-300 font-medium mb-1">
                            Transaction Hash
                          </p>
                          <div className="flex items-center gap-2">
                            <code className="text-xs sm:text-sm font-mono text-blue-900 dark:text-blue-100 flex-1 break-all">
                              {payment.txHash}
                            </code>
                            <button
                          ...
                          <div className="relative pt-2">
                            <div className="flex mb-2 items-center justify-between gap-2">
                              ...
                              <div className="text-right">
                                <span className="text-xs sm:text-sm font-semibold text-green-600 dark:text-green-400 break-words">
                    ...
                    {/* Right: Actions */}
                    <div className="lg:w-48 flex flex-row lg:flex-col gap-2 sm:gap-3">
                      <Button
                        variant="success"
                        size="lg"
                        onClick={() => handleApprove(payment.debtor.id, payment.id, payment.amount)}
                        className="flex-1 lg:flex-initial flex items-center justify-center gap-2 hover:scale-105 transition-transform"
